          ...
          <div className="row g-4 g-xxl-5">
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                <img className="rounded-lg" src="/assets/img/dig1.jpg" alt="" />
                <h2>
                  Captivating strategies that engage audiences and elevate your
                  brand.
                </h2>
                <p>
                  From research to execution, our digital marketing services
                  combine strategy, creativity, and data to help brands grow,
                  reach wider audiences, and drive real results.
                </p>
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The strategic approach behind our digital marketing solutions.
                </h3>
