          ...
          <div className="row g-4 g-xxl-5">
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                <img className="rounded-lg" src="/assets/img/med2.jpg" alt="" />
                <h2>
                  Social media management drives meaningfulconnections that
                  build brand loyalty and boost engagement.
                </h2>
                <p>
                  Effective social media strategies combine content creation,
                  community engagement, and data analytics to grow your brand's
                  online presence. By managing platforms strategically, we
                  foster authentic audience relationships that translate into
                  business growth.
                </p>
                ...
                <div className="row g-4">
                  <div className="col-6">
                    <img src="/assets/img/med1.jpg" alt="" />
                  </div>
                  <div className="col-6">
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The strategic approach behind our social media management
                  solutions.{" "}
                </h3>
