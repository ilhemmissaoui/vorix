          ...
          <div className="row g-4 g-xxl-5">
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                <img className="rounded-lg" src="/assets/img/dev1.jpg" alt="" />
                <h2>
                  We believe in the power of web development to drive societal
                  changeone line of code at a time.
                </h2>
                <p>
                  At Sole Digital Media, we deliver comprehensive web and
                  e-commerce solutions that boost your digital presence and
                  unlock business growth. From design to deployment and ongoing
                  support, we create visually stunning, user-friendly, and
                  SEO-optimized websites that drive traffic, engagement, and
                  conversions—empowering your success in the digital
                  marketplace.
                </p>
                ...
                <div className="row g-4">
                  <div className="col-6">
                    <img src="/assets/img/dev2.jpg" alt="" />
                  </div>
                  <div className="col-6">
