            ...
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                ...
                <h2>
                  ...
                  society.One piece of meaningful content at a time.
                </h2>
                <p>
                  At Sole Digital Media, we create compelling content that
                  strengthens your brand and drives engagement. From strategy to
                  storytelling, our content solutions captivate audiences, build
                  trust, and deliver real results across digital platforms.
                </p>
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The creative process behind our impactful content creation.
                </h3>
