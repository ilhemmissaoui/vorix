            ...
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                ...
                <p>
                  ...
                  usability, clarity, and user satisfaction. From research to
                  prototyping, we build intuitive experiences that drive
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The creative process behind our UX design solutions.
                </h3>
