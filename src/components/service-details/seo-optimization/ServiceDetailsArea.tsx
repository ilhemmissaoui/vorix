          ...
          <div className="row g-4 g-xxl-5">
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                <img className="rounded-lg" src="/assets/img/seo1.jpg" alt="" />
                <h2>
                  SEO optimization unlocks visibility,connecting brands with the
                ...
                <p>
                  ...
                  results. By combining technical audits, content optimization,
                  and continuous performance monitoring, we create websites that
                  are both search engine–friendly and user-centric—driving
                  sustainable growth, increased traffic, and higher conversions
                ...
                <div className="row g-4">
                  <div className="col-6">
                    <img src="/assets/img/seo3.jpg" alt="" />
                  </div>
                  <div className="col-6">
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The strategic approach behind our SEO optimization solutions.
                </h3>
