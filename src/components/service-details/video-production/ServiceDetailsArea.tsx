            ...
            <div className="col-12 col-lg-8">
              <div className="service-details-content">
                ...
                <p>
                  ...
                  combine creativity, technical expertise, and storytelling to
                  deliver compelling videos that resonate with your audience and
              ...
              <div className="faq-accordion service-details-faq">
                <h3 className="mb-5">
                  The strategic approach behind our video production solutions.{" "}
                </h3>
