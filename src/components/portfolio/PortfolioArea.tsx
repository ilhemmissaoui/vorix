          ...
          <div className="row g-4 g-xl-5">
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/burger/burger.png" alt="" />
            ...
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/homeArrow/homeArrow.png" alt="" />
            ...
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/tourGuide/tourGuide.png" alt="" />
            ...
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/extraBeauty/extraBeauty.png" alt="" />
            ...
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/pulse/pulse.png" alt="" />
            ...
            <div className="col-12 col-md-6">
              <div className="portfolio-card">
                <img src="/assets/img/cavaliero/cavaliero.png" alt="" />
