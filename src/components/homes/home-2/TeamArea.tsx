          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="process-card-two">
                ...
                <h2>Excellence</h2>
                <p className="mb-0">
                  Delivering uncompromising quality and consistency in every
                  project.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="process-card-two">
                ...
                <h2>Innovation</h2>
                <p className="mb-0">
                  Embracing change, technology, innovation, forward-thinking
                  ideas.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="process-card-two">
                ...
                <h2>Integrity</h2>
                <p className="mb-0">
                  Operating with transparency, accountability,integrity and
                  respect.
                </p>
              </div>
            </div>
            <div className="col-lg-6 col-md-6">
              <div className="process-card-two">
                <div className="icon-wrapper">
                  ...
                  >
                    <path
                      d="M4 14L10 20M20 10L14 4M22 12L12 22L2 12L12 2L22 12Z"
                      stroke="#ff971e"
                      stroke-width="2"
                ...
                <h2>Collaboration</h2>
                <p className="mb-0">
                  Building meaningful partnerships with clients and team
                  members.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-6 col-md-6">
              <div className="process-card-two">
                <div className="icon-wrapper">
                  ...
                  >
                    <path
                      d="M12 2V5M12 19V22M4.93 4.93L7.05 7.05M16.95 16.95L19.07 19.07M2 12H5M19 12H22M4.93 19.07L7.05 16.95M16.95 7.05L19.07 4.93M9 12a3 3 0 106 0 3 3 0 00-6 0z"
                      stroke="#ff971e"
                      stroke-width="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
